...
```
Выйди из bluetoothctl:
```
quit
```
Ппосмотреть статус всех устройств сразу, запускать из консоли Linux:
```
bt-device -l       # список устройств
bt-device -i <MAC> # информация по устройству
```
